...
<div class="py-5 px-4">
    <form method="POST" action="{{ route('register') }}">
                ...
                <div class="bg-white rounded-2 p-5">
                    ...
                    <div id="steptwo" style="display: none;">
                        <p>
                            ...
                            <input id="national" class="form-control p-2" type="text" required name="national_id" placeholder="National ID" />
                        </p>
                        <p>
        ...
        <div id="plans" class="py-5 px-4" style="display: none;">
            ...
            <div class="row justify-content-center">
                <div id="plan-1" class="col-lg-4 col-sm-6">
                    <div class="card">
                        <div class="card-body">
                            <div>
                            ...
                            <div>
                                <span class="text-primary">
                                    <span class="fw-bold" style="font-size: 3.5rem;">$<span id="price-1">39</span></span>
                                    <span>/Month</span>
                                </span>
                            </div>
                ...
                <div id="plan-2" class="col-lg-4 col-sm-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div>
                                <span class="text-primary">
                                    <span class="fw-bold" style="font-size: 3.5rem;">$<span id="price-2">59</span></span>
                                    <span>/Month</span>
                                </span>
                            </div>
                            <ul class="list-unstyled">
                ...
                <div id="plan-3" class="col-lg-4 col-sm-6">
                    <div class="card">
                        <div class="card-body">
                            <div>
                            ...
                            <div>
                                <span class="text-primary">
                                    <span class="fw-bold" style="font-size: 3.5rem;">$<span id="price-3">79</span></span>
                                    <span>/Month</span>
                                </span>
                            </div>
                            <ul class="list-unstyled">
        ...
        <input style="display:none;" id="amount" name="amount" class="form-control p-2" type="text" required/>
        ...
        <div class="text-center">
            <button class="btn btn-primary" id="submit_btn" type="submit" style="display: none;">Signup</button>
        </div>
    </form>
</div>
