<!DOCTYPE html>
    ...
    <body>
		...
		<div class="row py-4 px-2 px-md-4">
			...
			<video id="remoteVideo" autoplay="" style="width: 100vw; height: auto;" controls="" ></video>
			</div>
			...
			<video id="localVideo" autoplay="" controls="" style="width: 30vw; height: 30vh;"></video>
			</div>
            ...
            <script>
                ...
                const ipAddress = DocIP; // "192.168.0.2" Replace with the IP address of the other device
