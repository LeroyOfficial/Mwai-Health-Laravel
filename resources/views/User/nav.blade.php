					...
					<ul class="list-unstyled d-flex justify-content-center fw-bold fs-5 text-capitalize pt-1">
						...
						<li class="mx-2"><a @auth href="{{url('patient/contact_us')}}" @else href="{{url('/contact_us')}}" @endauth>Contact</a></li>
                            @auth
                                ...
                                <li class="mx-2"><a href="{{url('patient/orders')}}">Orders</a></li>
                            @endauth
					</ul>
				</div>
		...
		<div class="col-2 col-sm-2 d-block d-lg-none">
			<div class="dropdown"><button class="btn dropdown-toggle" aria-expanded="false" data-bs-toggle="dropdown" type="button"><i class="fas fa-align-justify"></i></button>
				<div class="dropdown-menu">
                    ...
                    @endauth
                    <a class="dropdown-item" @auth href="{{url('patient/about')}}" @else href="{{url('/about')}}" @endauth>About</a>
                    <a class="dropdown-item" @auth href="{{url('patient/services')}}" @else href="{{url('/services')}}" @endauth>Services</a>
                    <a class="dropdown-item" @auth href="{{url('patient/contact_us')}}" @else href="{{url('/contact_us')}}" @endauth>Contact</a>
                    @auth
                        <a class="dropdown-item" href="{{url('patient/appointments')}}">Appointments</a>
                        <a class="dropdown-item" href="{{url('patient/chats')}}">Chat</a>
                        <a class="dropdown-item" href="{{url('patient/shop')}}">Shop</a>
